...
function TextPartie () {
    return (
        <section className='text-partie container'>
            <h2>Help us build open-source tools for fractal governance in Web3.</h2>
            ...
            <p>You can use any wallet and donate any crypto. When you click on <strong>"Donate"</strong>, You will be directed to our donation page where you can make your donation. We use NowPayment Protocol for secure, fast & affordable web3 donations. </p>
